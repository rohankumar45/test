...
class TgUploader:
    ...
    async def __user_settings(self):
        ...
        self.__as_doc = user_dict.get('as_doc', False) or ('as_doc' not in user_dict and config_dict['AS_DOCUMENT']) or self.__listener.compress
    ...
    async def __send_ss(self, ss_image, buttons):
        try:
