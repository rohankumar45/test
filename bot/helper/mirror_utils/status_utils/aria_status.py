...
from bot.helper.ext_utils.bot_utils import MirrorStatus, get_readable_time, EngineStatus, presuf_remname_name, sync_to_async
...
class Aria2Status:
    ...
    async def cancel_download(self):
        ...
        if self.__download.seeder and self.seeding:
            ...
            await self.__listener.onUploadError(f'Seeding stopped with Ratio: {self.ratio()} and Time: {self.seeding_time()}', self.name())
